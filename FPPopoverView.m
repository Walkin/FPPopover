...
-(CGGradientRef)newGradient
{
    ...
    else if(self.tint == FPPopoverGreenTint)
    {
        if(_arrowDirection == FPPopoverArrowDirectionUp)
        {
            colors[0] = 193.0/255.0; colors[1] = 216.0/255.0; colors[2] = 55.0/255.0;
            colors[4] = 193.0/255.0; colors[5] = 216.0/255.0;  colors[6] = 55.0/255.0;
            colors[3] = colors[7] = 1.0;
...
- (void)drawRect:(CGRect)rect
{
    ...
    else if(self.tint == FPPopoverGreenTint)
    {
        ...
        CGContextSetRGBFillColor(ctx, 193.0/255.0, 216.0/255.0, 55.0/255.0, 1.0);
    }
    ...
    //firstLine
    if(self.tint == FPPopoverGreenTint)
    {
        CGContextSetRGBStrokeColor(ctx, 193.0/255.0, 216.0/255.0, 55.0/255.0, 1.0);
    }
    else{
        CGContextSetRGBStrokeColor(ctx, 0.7, 0.7, 0.7, 1.0);
    }
